...
from espnet.espnet.nets.pytorch_backend.wavenet import decode_mu_law
from espnet.espnet.nets.pytorch_backend.wavenet import encode_mu_law
from espnet.espnet.nets.pytorch_backend.wavenet import WaveNet
