...
predefined_st = {
    "pytorch": {
        "rnn": "espnet.espnet.nets.pytorch_backend.e2e_st:E2E",
        "transformer": "espnet.espnet.nets.pytorch_backend.e2e_st_transformer:E2E",
    },
    # "chainer": {
    #     "rnn": "espnet.espnet.nets.chainer_backend.e2e_st:E2E",
    #     "transformer": "espnet.espnet.nets.chainer_backend.e2e_st_transformer:E2E",
    # }
}
