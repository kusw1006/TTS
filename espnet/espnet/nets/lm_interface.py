...
class LMInterface(ScorerInterface):
    ...
    def build(cls, n_vocab: int, **kwargs):
        ...
        from espnet.espnet.bin.lm_train import get_parser
...
predefined_lms = {
    "pytorch": {
        "default": "espnet.espnet.nets.pytorch_backend.lm.default:DefaultRNNLM",
        "seq_rnn": "espnet.espnet.nets.pytorch_backend.lm.seq_rnn:SequentialRNNLM",
        "transformer": "espnet.espnet.nets.pytorch_backend.lm.transformer:TransformerLM",
    },
    "chainer": {"default": "espnet.espnet.lm.chainer_backend.lm:DefaultRNNLM"},
}
