...
from espnet.espnet.nets.chainer_backend.asr_interface import ChainerASRInterface
from espnet.espnet.nets.chainer_backend.transformer.attention import MultiHeadAttention
from espnet.espnet.nets.chainer_backend.transformer import ctc
from espnet.espnet.nets.chainer_backend.transformer.decoder import Decoder
from espnet.espnet.nets.chainer_backend.transformer.encoder import Encoder
from espnet.espnet.nets.chainer_backend.transformer.label_smoothing_loss import (
    LabelSmoothingLoss,  # noqa: H301
)
from espnet.espnet.nets.chainer_backend.transformer.plot import PlotAttentionReport
from espnet.espnet.nets.chainer_backend.transformer.training import CustomConverter
from espnet.espnet.nets.chainer_backend.transformer.training import CustomUpdater
from espnet.espnet.nets.chainer_backend.transformer.training import (
...
class E2E(ChainerASRInterface):
    ...
    def recognize(self, x_block, recog_args, char_list=None, rnnlm=None):
        ...
        Args:
            ...
            `espnet.espnet.lm.chainer_backend.lm`.
