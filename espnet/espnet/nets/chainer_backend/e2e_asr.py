...
from espnet.espnet.nets.chainer_backend.ctc import ctc_for
from espnet.espnet.nets.chainer_backend.rnn.attentions import att_for
from espnet.espnet.nets.chainer_backend.rnn.decoders import decoder_for
from espnet.espnet.nets.chainer_backend.rnn.encoders import encoder_for
from espnet.espnet.nets.e2e_asr_common import label_smoothing_dist
from espnet.espnet.nets.pytorch_backend.e2e_asr import E2E as E2E_pytorch
...
class E2E(ChainerASRInterface):
    ...
    def recognize(self, x, recog_args, char_list, rnnlm=None):
        ...
        Args:
            ...
            rnnlm (Module): RNNLM module defined at `espnet.espnet.lm.chainer_backend.lm`.
    ...
    def custom_converter(subsampling_factor=0):
        ...
        from espnet.espnet.nets.chainer_backend.rnn.training import CustomConverter
    ...
    def custom_updater(iters, optimizer, converter, device=-1, accum_grad=1):
        ...
        from espnet.espnet.nets.chainer_backend.rnn.training import CustomUpdater
    ...
    def custom_parallel_updater(iters, optimizer, converter, devices, accum_grad=1):
        ...
        from espnet.espnet.nets.chainer_backend.rnn.training import CustomParallelUpdater
