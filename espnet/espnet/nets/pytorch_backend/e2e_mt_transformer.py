...
from espnet.espnet.nets.pytorch_backend.e2e_mt import Reporter
...
from espnet.espnet.nets.pytorch_backend.nets_utils import to_device
...
class E2E(MTInterface, torch.nn.Module):
    ...
    def __init__(self, idim, odim, args, ignore_id=-1):
        ...
        self.adim = args.adim
        if args.report_bleu:
            from espnet.espnet.nets.e2e_mt_common import ErrorCalculator
