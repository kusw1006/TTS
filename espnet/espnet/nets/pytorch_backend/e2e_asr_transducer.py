...
from espnet.espnet.nets.pytorch_backend.nets_utils import to_torch_tensor
from espnet.espnet.nets.pytorch_backend.rnn.attentions import att_for
from espnet.espnet.nets.pytorch_backend.rnn.encoders import encoder_for
from espnet.espnet.nets.pytorch_backend.transducer.initializer import initializer
from espnet.espnet.nets.pytorch_backend.transducer.loss import TransLoss
from espnet.espnet.nets.pytorch_backend.transducer.rnn_decoders import decoder_for
from espnet.espnet.nets.pytorch_backend.transducer.transformer_decoder import Decoder
from espnet.espnet.nets.pytorch_backend.transducer.utils import prepare_loss_inputs
...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def __init__(self, idim, odim, args, ignore_id=-1, blank_id=0):
        ...
        if args.report_cer or args.report_wer:
            from espnet.espnet.nets.e2e_asr_common import ErrorCalculatorTrans
