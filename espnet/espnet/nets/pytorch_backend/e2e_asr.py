...
from espnet.espnet.nets.pytorch_backend.initialization import lecun_normal_init_parameters
from espnet.espnet.nets.pytorch_backend.initialization import set_forget_bias_to_one
