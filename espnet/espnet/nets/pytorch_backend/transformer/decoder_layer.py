...
class DecoderLayer(nn.Module):
    ...
    :param espnet.espnet.nets.pytorch_backend.transformer.attention.MultiHeadedAttention
        self_attn: self attention module
    :param espnet.espnet.nets.pytorch_backend.transformer.attention.MultiHeadedAttention
        src_attn: source attention module
    :param espnet.espnet.nets.pytorch_backend.transformer.positionwise_feed_forward.
