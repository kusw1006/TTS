...
from espnet.espnet.utils.training.batchfy import BATCH_COUNT_CHOICES
...
def get_parser(parser=None, required=True):
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="model defined module (default: espnet.espnet.nets.xxx_backend.e2e_asr:E2E)",
    )
    # encoder
    parser.add_argument(
...
def main(cmd_args):
    ...
    if args.model_module is None:
        model_module = "espnet.espnet.nets." + args.backend + "_backend.e2e_asr:E2E"
    else:
    ...
    if args.num_spkrs == 1:
        if args.backend == "chainer":
            from espnet.espnet.asr.chainer_backend.asr import train

            train(args)
        elif args.backend == "pytorch":
            from espnet.espnet.asr.pytorch_backend.asr import train
        ...
        if args.backend == "pytorch":
            from espnet.espnet.asr.pytorch_backend.asr_mix import train
