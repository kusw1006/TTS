...
def get_parser(parser=None, required=True):
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="model defined module (default: espnet.espnet.nets.xxx_backend.e2e_mt:E2E)",
    )
    # loss related
    parser.add_argument(
...
def main(cmd_args):
    ...
    if args.model_module is None:
        model_module = "espnet.espnet.nets." + args.backend + "_backend.e2e_mt:E2E"
    else:
    ...
    if args.backend == "pytorch":
        from espnet.espnet.mt.pytorch_backend.mt import train
