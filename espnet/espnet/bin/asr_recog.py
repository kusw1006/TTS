...
def main(args):
    ...
    if args.num_spkrs == 1:
        if args.backend == "chainer":
            from espnet.espnet.asr.chainer_backend.asr import recog
            ...
            if args.num_encs == 1:
                ...
                if args.api == "v2":
                    from espnet.espnet.asr.pytorch_backend.recog import recog_v2

                    recog_v2(args)
                else:
                    from espnet.espnet.asr.pytorch_backend.asr import recog
        ...
        if args.backend == "pytorch":
            from espnet.espnet.asr.pytorch_backend.asr_mix import recog
