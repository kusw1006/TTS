...
def get_parser(parser=None, required=True):
    ...
    parser.add_argument(
        ...
        "(default: espnet.espnet.nets.xxx_backend.lm.default:DefaultRNNLM)",
    )
    return parser
...
def main(cmd_args):
    ...
    if args.backend == "chainer":
        from espnet.espnet.lm.chainer_backend.lm import train

        train(args)
    elif args.backend == "pytorch":
        from espnet.espnet.lm.pytorch_backend.lm import train
