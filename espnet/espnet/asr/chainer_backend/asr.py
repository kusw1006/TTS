...
from espnet.espnet.asr.asr_utils import chainer_load
...
from espnet.espnet.utils.deterministic_utils import set_deterministic_chainer
...
from espnet.espnet.utils.training.iterators import ToggleableShufflingMultiprocessIterator
from espnet.espnet.utils.training.iterators import ToggleableShufflingSerialIterator
...
# rnnlm
import espnet.espnet.lm.chainer_backend.extlm as extlm_chainer
import espnet.espnet.lm.chainer_backend.lm as lm_chainer
...
def train(args):
    ...
    if args.opt == "noam":
        from espnet.espnet.nets.chainer_backend.transformer.training import VaswaniRule
...
def recog(args):
    ...
    if hasattr(train_args, "model_module"):
        ...
        model_module = "espnet.espnet.nets.chainer_backend.e2e_asr:E2E"
