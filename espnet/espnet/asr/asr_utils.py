...
class PlotAttentionReport(extension.Extension):
    ...
    Args:
        att_vis_fn (espnet.espnet.nets.*_backend.e2e_asr.E2E.calculate_all_attentions):
            Function of attention visualization.
        data (list[tuple(str, dict[str, list[Any]])]): List json utt key items.
        outdir (str): Directory to save figures.
        converter (espnet.espnet.asr.*_backend.asr.CustomConverter): Function to convert data.
...
def get_model_conf(model_path, conf_path=None):
    ...
    if conf_path is None:
        ...
        # model_conf = "/home/dcl2003/TTS/downloads/ptFastSpeech/exp/EMO_char_train_no_dev_pytorch_train_fastspeech.sgst2.spkid/results/model.json"
    else:
