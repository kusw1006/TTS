...
from espnet.espnet.asr.asr_utils import parse_hypothesis
...
class PlotAttentionReport(extension.Extension):
    ...
    Args:
        att_vis_fn (espnet.espnet.nets.*_backend.e2e_asr.calculate_all_attentions):
            Function of attention visualization.
        data (list[tuple(str, dict[str, dict[str, Any]])]): List json utt key items.
        outdir (str): Directory to save figures.
        converter (espnet.espnet.asr.*_backend.asr.CustomConverter):
