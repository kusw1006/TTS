...
from espnet.espnet.asr.asr_utils import adadelta_eps_decay
from espnet.espnet.asr.asr_utils import add_results_to_json
from espnet.espnet.asr.asr_utils import CompareValueTrigger
from espnet.espnet.asr.asr_utils import format_mulenc_args
from espnet.espnet.asr.asr_utils import get_model_conf
from espnet.espnet.asr.asr_utils import plot_spectrogram
from espnet.espnet.asr.asr_utils import restore_snapshot
from espnet.espnet.asr.asr_utils import snapshot_object
from espnet.espnet.asr.asr_utils import torch_load
from espnet.espnet.asr.asr_utils import torch_resume
from espnet.espnet.asr.asr_utils import torch_snapshot
from espnet.espnet.asr.pytorch_backend.asr_init import load_trained_model
from espnet.espnet.asr.pytorch_backend.asr_init import load_trained_modules
import espnet.espnet.lm.pytorch_backend.extlm as extlm_pytorch
from espnet.espnet.nets.asr_interface import ASRInterface
from espnet.espnet.nets.pytorch_backend.e2e_asr import pad_list
import espnet.espnet.nets.pytorch_backend.lm.default as lm_pytorch
from espnet.espnet.nets.pytorch_backend.streaming.segment import SegmentStreamingE2E
from espnet.espnet.nets.pytorch_backend.streaming.window import WindowStreamingE2E
from espnet.espnet.transform.spectrogram import IStft
from espnet.espnet.transform.transformation import Transformation
from espnet.espnet.utils.cli_writers import file_writer_helper
from espnet.espnet.utils.dataset import ChainerDataLoader
from espnet.espnet.utils.dataset import TransformDataset
from espnet.espnet.utils.deterministic_utils import set_deterministic_pytorch
from espnet.espnet.utils.dynamic_import import dynamic_import
from espnet.espnet.utils.io_utils import LoadInputsAndTargets
from espnet.espnet.utils.training.batchfy import make_batchset
from espnet.espnet.utils.training.evaluator import BaseEvaluator
from espnet.espnet.utils.training.iterators import ShufflingEnabler
from espnet.espnet.utils.training.tensorboard_logger import TensorboardLogger
from espnet.espnet.utils.training.train_utils import check_early_stop
from espnet.espnet.utils.training.train_utils import set_early_stop
...
class CustomUpdater(StandardUpdater):
    ...
    def update_core(self):
        ...
        if self.grad_noise:
            from espnet.espnet.asr.asr_utils import add_gradient_noise
...
def train(args):
    ...
    if args.opt == "adadelta":
        ...
        from espnet.espnet.nets.pytorch_backend.transformer.optimizer import get_std_opt
    ...
    if args.train_dtype in ("O0", "O1", "O2", "O3"):
        ...
        from espnet.espnet.nets.pytorch_backend.ctc import CTC
