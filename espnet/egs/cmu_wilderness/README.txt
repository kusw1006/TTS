...
There are going to be two forms of this recipe:
	...
	using an older version of espnet.espnet. 
	2. A recipe that trains using the latest
	version of espnet.espnet. Use this if you don't care about replication: You just
...
===2. Training a CMU Wilderness model with the latest version of espnet.espnet.===
