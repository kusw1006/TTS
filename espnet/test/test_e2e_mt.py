...
@pytest.mark.parametrize(
    "module, model_dict",
    [
        ("espnet.espnet.nets.pytorch_backend.e2e_mt", {}),
        ("espnet.espnet.nets.pytorch_backend.e2e_mt", {"atype": "noatt"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_mt", {"atype": "dot"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_mt", {"atype": "coverage"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_mt", {"atype": "multi_head_dot"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_mt", {"atype": "multi_head_add"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_mt", {"etype": "grup"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_mt", {"etype": "lstmp"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_mt", {"etype": "bgrup"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_mt", {"etype": "blstmp"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_mt", {"etype": "bgru"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_mt", {"etype": "blstm"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_mt", {"context_residual": True}),
    ],
)
...
def test_sortagrad_trainable(module):
    ...
    if module == "pytorch":
        import espnet.espnet.nets.pytorch_backend.e2e_mt as m
    else:
        import espnet.espnet.nets.chainer_backend.e2e_mt as m
...
def test_loss(etype):
    # ch = importlib.import_module('espnet.espnet.nets.chainer_backend.e2e_mt')
    th = importlib.import_module("espnet.espnet.nets.pytorch_backend.e2e_mt")
...
@pytest.mark.parametrize(
    "module, atype",
    [
        ("espnet.espnet.nets.pytorch_backend.e2e_mt", "noatt"),
        ("espnet.espnet.nets.pytorch_backend.e2e_mt", "dot"),
        ("espnet.espnet.nets.pytorch_backend.e2e_mt", "add"),
        ("espnet.espnet.nets.pytorch_backend.e2e_mt", "coverage"),
        ("espnet.espnet.nets.pytorch_backend.e2e_mt", "multi_head_dot"),
        ("espnet.espnet.nets.pytorch_backend.e2e_mt", "multi_head_add"),
    ],
)
...
def test_torch_save_and_load():
    m = importlib.import_module("espnet.espnet.nets.pytorch_backend.e2e_mt")
...
@pytest.mark.parametrize("module", ["espnet.espnet.nets.pytorch_backend.e2e_mt"])
