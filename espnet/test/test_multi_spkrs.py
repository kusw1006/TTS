...
@pytest.mark.parametrize(
    ...
    [
        ("vggblstmp", "lstm", 2, True, "espnet.espnet.nets.pytorch_backend.e2e_asr_mix", 0),
        ("vggbgrup", "gru", 2, True, "espnet.espnet.nets.pytorch_backend.e2e_asr_mix", 1),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [("vggblstmp", "lstm", 2, "espnet.espnet.nets.pytorch_backend.e2e_asr_mix", 0)],
)
...
@pytest.mark.parametrize(
    ...
    [(True, True, 3, 2, "espnet.espnet.nets.pytorch_backend.e2e_asr_mix")],
)
def test_dnn_beamformer(use_frontend, use_beamformer, bnmask, num_spkrs, m_str):
    ...
    b = importlib.import_module("espnet.espnet.nets.pytorch_backend.frontends.beamformer")
