...
@pytest.mark.parametrize(
    ...
    [
        ("blstmp", "lstm", "espnet.espnet.nets.chainer_backend.e2e_asr", 0),
        ("blstmp", "lstm", "espnet.espnet.nets.pytorch_backend.e2e_asr", 1),
        ("vggblstmp", "lstm", "espnet.espnet.nets.chainer_backend.e2e_asr", 2),
        ("vggblstmp", "lstm", "espnet.espnet.nets.pytorch_backend.e2e_asr", 3),
        ("bgrup", "gru", "espnet.espnet.nets.chainer_backend.e2e_asr", 4),
        ("bgrup", "gru", "espnet.espnet.nets.pytorch_backend.e2e_asr", 5),
        ("vggbgrup", "gru", "espnet.espnet.nets.chainer_backend.e2e_asr", 6),
        ("vggbgrup", "gru", "espnet.espnet.nets.pytorch_backend.e2e_asr", 7),
    ],
)
...
@pytest.mark.parametrize(
    ("etype", "dtype", "m_str"),
    [
        ("blstmp", "lstm", "espnet.espnet.nets.chainer_backend.e2e_asr"),
        ("blstmp", "lstm", "espnet.espnet.nets.pytorch_backend.e2e_asr"),
        ("vggblstmp", "lstm", "espnet.espnet.nets.chainer_backend.e2e_asr"),
        ("vggblstmp", "lstm", "espnet.espnet.nets.pytorch_backend.e2e_asr"),
        ("bgrup", "gru", "espnet.espnet.nets.chainer_backend.e2e_asr"),
        ("bgrup", "gru", "espnet.espnet.nets.pytorch_backend.e2e_asr"),
        ("vggbgrup", "gru", "espnet.espnet.nets.chainer_backend.e2e_asr"),
        ("vggbgrup", "gru", "espnet.espnet.nets.pytorch_backend.e2e_asr"),
    ],
)
