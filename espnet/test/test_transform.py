...
from espnet.espnet.transform.add_deltas import add_deltas
from espnet.espnet.transform.cmvn import CMVN
from espnet.espnet.transform.functional import FuncTrans
from espnet.espnet.transform.spectrogram import logmelspectrogram
