...
from espnet.espnet.nets.pytorch_backend.nets_utils import pad_list
...
@pytest.mark.parametrize(
    "module, model_dict",
    [
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"elayers": 2, "dlayers": 2}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"etype": "vggblstmp"}),
        (
            "espnet.espnet.nets.chainer_backend.e2e_asr",
            {"etype": "vggblstmp", "atype": "noatt"},
        ),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"etype": "vggblstmp", "atype": "dot"}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"etype": "grup"}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"etype": "lstmp"}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"etype": "bgrup"}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"etype": "blstmp"}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"etype": "bgru"}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"etype": "blstm"}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"etype": "vgggru"}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"etype": "vggbgrup"}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"etype": "vgglstm"}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"etype": "vgglstmp"}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"etype": "vggbgru"}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"etype": "vggbgrup"}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"etype": "vggblstmp", "dtype": "gru"}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"mtlalpha": 0.0}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"mtlalpha": 1.0}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"sampling_probability": 0.5}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"ctc_type": "builtin"}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"ctc_weight": 0.0}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"ctc_weight": 1.0}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"report_cer": True}),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", {"report_wer": True}),
        (
            "espnet.espnet.nets.chainer_backend.e2e_asr",
        ...
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"elayers": 2, "dlayers": 2}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"etype": "grup"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"etype": "lstmp"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"etype": "bgrup"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"etype": "blstmp"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"etype": "bgru"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"etype": "blstm"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"etype": "vgggru"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"etype": "vgggrup"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"etype": "vgglstm"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"etype": "vgglstmp"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"etype": "vggbgru"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"etype": "vggbgrup"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"etype": "vggblstmp", "dtype": "gru"}),
        (
            "espnet.espnet.nets.pytorch_backend.e2e_asr",
            {"etype": "vggblstmp", "atype": "noatt"},
        ),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"etype": "vggblstmp", "atype": "add"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"etype": "vggblstmp", "atype": "dot"}),
        (
            "espnet.espnet.nets.pytorch_backend.e2e_asr",
        ...
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"mtlalpha": 0.0}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"mtlalpha": 1.0}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"sampling_probability": 0.5}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"ctc_type": "builtin"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"ctc_weight": 0.0}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"ctc_weight": 1.0}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"context_residual": True}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"grad_noise": True}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"report_cer": True}),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", {"report_wer": True}),
        (
            "espnet.espnet.nets.pytorch_backend.e2e_asr",
            {"report_cer": True, "report_wer": True},
        ),
...
def test_window_streaming_e2e_encoder_and_ctc_with_offline_attention():
    m = importlib.import_module("espnet.espnet.nets.pytorch_backend.e2e_asr")
    args = make_arg()
    model = m.E2E(40, 5, args)
    n = importlib.import_module("espnet.espnet.nets.pytorch_backend.streaming.window")
...
def test_segment_streaming_e2e():
    ...
    args.batchsize = 0
    model = m.E2E(40, 5, args)
    n = importlib.import_module("espnet.espnet.nets.pytorch_backend.streaming.segment")
...
def test_gradient_noise_injection(module):
    ...
    if module == "pytorch":
        import espnet.espnet.nets.pytorch_backend.e2e_asr as m
    else:
        import espnet.espnet.nets.chainer_backend.e2e_asr as m
...
def test_chainer_ctc_type():
    ch = importlib.import_module("espnet.espnet.nets.chainer_backend.e2e_asr")
    np.random.seed(0)
    batch = prepare_inputs("chainer")
...
def test_loss_and_ctc_grad(etype):
    ch = importlib.import_module("espnet.espnet.nets.chainer_backend.e2e_asr")
    th = importlib.import_module("espnet.espnet.nets.pytorch_backend.e2e_asr")
...
@pytest.mark.parametrize(
    "module, atype",
    [
        ("espnet.espnet.nets.chainer_backend.e2e_asr", "noatt"),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", "dot"),
        ("espnet.espnet.nets.chainer_backend.e2e_asr", "location"),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", "noatt"),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", "dot"),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", "add"),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", "location"),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", "coverage"),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", "coverage_location"),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", "location2d"),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", "location_recurrent"),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", "multi_head_dot"),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", "multi_head_add"),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", "multi_head_loc"),
        ("espnet.espnet.nets.pytorch_backend.e2e_asr", "multi_head_multi_res_loc"),
    ],
)
...
def test_chainer_save_and_load():
    m = importlib.import_module("espnet.espnet.nets.chainer_backend.e2e_asr")
    utils = importlib.import_module("espnet.espnet.asr.asr_utils")
    args = make_arg()
    model = m.E2E(40, 5, args)
    # initialize randomly
...
@pytest.mark.parametrize(
    "module",
    ["espnet.espnet.nets.chainer_backend.e2e_asr", "espnet.espnet.nets.pytorch_backend.e2e_asr"],
)
