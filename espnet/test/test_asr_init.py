...
def make_arg(**kwargs):
    train_defaults = dict(
        ...
        model_module="espnet.espnet.nets.pytorch_backend.e2e_asr:E2E",
    )
...
def test_pytorch_trainable_transferable_and_decodable(
    ...
    module = importlib.import_module("espnet.espnet.nets.pytorch_backend.e2e_asr")
    ...
    transfer = importlib.import_module("espnet.espnet.asr.pytorch_backend.asr_init")
