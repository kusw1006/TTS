...
from espnet.espnet.nets.pytorch_backend.e2e_tts_fastspeech import FeedForwardTransformer
from espnet.espnet.nets.pytorch_backend.e2e_tts_tacotron2 import Tacotron2
from espnet.espnet.nets.pytorch_backend.e2e_tts_transformer import Transformer
...
def make_taco2_args(**kwargs):
    defaults = dict(
        model_module="espnet.espnet.nets.pytorch_backend.e2e_tts_tacotron2:Tacotron2",
...
def make_transformer_args(**kwargs):
    defaults = dict(
        model_module="espnet.espnet.nets.pytorch_backend.e2e_tts_transformer:Transformer",
        embed_dim=0,
        spk_embed_dim=None,
