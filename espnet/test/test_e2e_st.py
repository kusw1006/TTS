...
@pytest.mark.parametrize(
    "module, model_dict",
    [
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"elayers": 2, "dlayers": 2}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"etype": "grup"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"etype": "lstmp"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"etype": "bgrup"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"etype": "blstmp"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"etype": "bgru"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"etype": "blstm"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"etype": "vgggru"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"etype": "vgggrup"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"etype": "vgglstm"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"etype": "vgglstmp"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"etype": "vggbgru"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"etype": "vggbgrup"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"etype": "vggblstmp", "dtype": "gru"}),
        (
            "espnet.espnet.nets.pytorch_backend.e2e_st",
            {"etype": "vggblstmp", "atype": "noatt"},
        ),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"etype": "vggblstmp", "atype": "add"}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"etype": "vggblstmp", "atype": "dot"}),
        (
            "espnet.espnet.nets.pytorch_backend.e2e_st",
        ...
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"asr_weight": 0.0}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"asr_weight": 0.2}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"mt_weight": 0.0}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"mt_weight": 0.2}),
        (
            "espnet.espnet.nets.pytorch_backend.e2e_st",
        ...
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"sampling_probability": 0.5}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"context_residual": True}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"grad_noise": True}),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"report_cer": True, "asr_weight": 0.0}),
        (
            "espnet.espnet.nets.pytorch_backend.e2e_st",
        ...
        ("espnet.espnet.nets.pytorch_backend.e2e_st", {"report_wer": True, "asr_weight": 0.0}),
        (
            "espnet.espnet.nets.pytorch_backend.e2e_st",
...
def test_gradient_noise_injection(module):
    ...
    if module == "pytorch":
        import espnet.espnet.nets.pytorch_backend.e2e_st as m
    else:
        raise NotImplementedError
...
def test_mtl_loss(etype):
    th = importlib.import_module("espnet.espnet.nets.pytorch_backend.e2e_st")
...
@pytest.mark.parametrize(
    "module, atype",
    [
        ("espnet.espnet.nets.pytorch_backend.e2e_st", "noatt"),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", "dot"),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", "add"),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", "location"),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", "coverage"),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", "coverage_location"),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", "location2d"),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", "location_recurrent"),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", "multi_head_dot"),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", "multi_head_add"),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", "multi_head_loc"),
        ("espnet.espnet.nets.pytorch_backend.e2e_st", "multi_head_multi_res_loc"),
    ],
)
...
def test_torch_save_and_load():
    m = importlib.import_module("espnet.espnet.nets.pytorch_backend.e2e_st")
...
@pytest.mark.parametrize("module", ["espnet.espnet.nets.pytorch_backend.e2e_st"])
